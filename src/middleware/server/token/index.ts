...
import { TOKEN_PRIVATE_KEY, TOKEN_PUBLIC_KEY, TOKEN_EXPIRE_DAYS } from "../../../config/token/index"
import { userAccessLevel } from "../../../fookingTypes/users";
 ...
 * 返回true表示操作成功
 */
export async function AddDeprecatedToken(authorizationText: string): Promise<boolean> {
    try {
